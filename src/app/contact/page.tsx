          ...
          <div
                ...
                >
                  <div className="flex flex-col justify-center items-center py-16">
                      ...
                      <h1 className="text-4xl text-poppins font-semibold text-gray-950">Contact</h1>
                    
                  </div>
                </div>
                 </section>
        <div className="font-serif max-w-6xl max-lg:max-w-3xl mx-auto p-4">
      <div className="bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded p-8">
        <h2 className="text-3xl text-gray-700 font-semibold text-center mt-11 mb-5">Get In Touch With Us</h2>
        <p className='text-poppins font-normal text-base text-text mb-16 text-center mx-auto'>For More Information About Our Product & Services. Please Feel Free To Drop Us An Email. Our Staff Always Be There To Help You Out. Do Not Hesitate!</p>
