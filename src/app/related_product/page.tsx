  ...
  <main>
    ...
    <div>
      ...
      <div className='flex items-center space-x-2'>
        ...
        {
          product.oldprice && (
            <span className='text-gry-300 font-bold line-through'>{product.oldprice}</span>
          )
        }
          ...
          <div className='w-[80%] '>
            <div className='flex flex-col'>
              ...
              <div className='flex justify-between'>
                <h1 className='sm:text-md md:text-3xl lg:text-3xl pt-4 font-bold text-slate-800'>Best Selling Products</h1>
                <a href="#products" className='md:px-7 sm:px-8 sm:text-sm md:text-sm py-2 hover:bg-gray-600 text-white text-center bg-gray-900 rounded-lg h-11  mt-0 max-w-32 '>
